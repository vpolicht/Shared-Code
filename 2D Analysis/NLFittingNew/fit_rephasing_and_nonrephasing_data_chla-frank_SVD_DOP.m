...
w2l = @(w) 2*pi*c./w;
%% Inputs
data_path = fullfile(base,'2D','Frank','LyX_Lab_Notebook','LaserLab','13-10-09','PostProcessingData');
results_path = fullfile(base,'2D','Frank','LyX_Lab_Notebook','LaserLab','13-10-09','PostProcessingData','NewFits');
figures_path = fullfile(base,'2D','Frank','LyX_Lab_Notebook','LaserLab','13-10-09','Figures');
...
flb = 1/(T(end)/(0.75*2*pi)); %require at least 3/4 period
rub = 1/85;
rlb = 1/(T(end));
...
save(fullfile(results_path,['fit_results_' s '.mat']),'best_model','-v7.3');
