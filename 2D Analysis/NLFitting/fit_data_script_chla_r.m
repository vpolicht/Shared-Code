...
if save_uncompressed_bkg;
    ...
    save(['Z:\2D\Frank\LyX_Lab_Notebook\LaserLab\13-09-05\PostProcessingData\' 'bkg_cube_r'],'bkg_cube_r','T');
    clear bkg_cube_r;
end
...
saveas(gcf,fullfile(figures_path,'frobenius_spectrum_rephasing.png'));
dlmwrite(fullfile(figures_path,'frobenius_spectrum_rephasing.txt'),[rZfaxis' frobeniusSpectrum],'\t');
...
for k=1:length(peaks);
    ...
    saveas(gcf,fullfile(figures_path,'Beat_Analysis_Fourier',['beats_at_rephasing_' num2str(peaks(k)) '_wn.png']));
    hold off;
end
