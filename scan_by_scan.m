...
twist = '';
date = '7-23-2020';
tdname = '2D_V2O3-spot1-100K-100ps-1';

% Which pump calibration file
calibname = '2DVIS-premeasurement-1j_CALIB';
...
for n = 1:nav
    filename = [tdname '_' num2str(time(end)) 'fs_' num2str(avnum(n)) '.bin'];
    temp = dir([datfolder sla filename]);
